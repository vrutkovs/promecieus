...
class SearchBar extends React.Component {
  ...
  render() {
    let btn = (
      <ReactBootstrap.Button type="submit" onClick={this.handleSubmit} block>
        Generate
      </ReactBootstrap.Button>
    );
    if (this.props != null && this.props.appName != null) {
      btn = <DeleteAppButton onDeleteApp={this.props.onDeleteApp} appName={this.props.appName} />;
    }
    return (
        ...
        <ReactBootstrap.FormGroup>
          <ReactBootstrap.Row>
            ...
            <ReactBootstrap.Col xs={3}>
              <ReactBootstrap.Container>{btn}</ReactBootstrap.Container>
      ...
      return (
        <ReactBootstrap.Row>
          <ReactBootstrap.Col xs={2}>
            <a target="_blank" href={this.props.apps[k]}>
              {k}
            </a>
          </ReactBootstrap.Col>
          <ReactBootstrap.Col xs={3}>
    ...
    return (
      <div className={searchClass}>
        ...
        <ReactBootstrap.Row>
          ...
          <ReactBootstrap.Col xs={4}>
            <ResourceQuotaStatus resourceQuota={this.state.resourceQuota || null} />
          </ReactBootstrap.Col>
          <ReactBootstrap.Col xs={4} />
        </ReactBootstrap.Row>
        <br />
